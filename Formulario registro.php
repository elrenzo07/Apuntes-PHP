...
<form name="form1" method="get" action="Insertar_Registro.php">
  <table border="0" align="center">
    ...
    <tr>
    <!--______________________Botonera inferior_____________________________________________________________-->
      <td align="center"><input type="submit" name="enviar" id="enviar" value="Enviar"></td>
      <td align="center"><input type="reset" name="Borrar" id="Borrar" value="Reset"></td>
    </tr><td>&nbsp;</td>
    <tr><td align="center"><input type="button" name="Borrard" id="Borrard" value="Borrar datos"></td>
    </tr>
  </table>
</form>
</body>
